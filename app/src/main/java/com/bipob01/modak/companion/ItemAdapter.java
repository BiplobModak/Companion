...
import static com.bipob01.modak.companion.Todo.getCat;
...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ArrayList<Categorie> cat = getCat();
        ...
        while (i < cat.size()) {
            if (Item.getCategorie().equals(cat.get(i).getName())) {
                ...
                if (Item.getStatus() == com.bipob01.modak.companion.Item.Status.DONE)
