...
public class addCatagory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat2 = Todo.getCat();
        CatAdapter adapter = new CatAdapter(addCatagory.this, cat2);
    ...
    public void delete(View v) {
        ...
        if (!Todo.cat.get(position).getName().equals("none")) {
            Todo.cat.remove(position);
    ...
    public void dialog(View view) {
        ...
        dialog.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if (name.equals(Todo.getCat().get(i).getName()))
                        ok = false;
                    i++;
                }
                if (ok) {
                    Todo.cat.add(new Categorie(name, finalColor));
