...
public class EditItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int i = 0;
        int selection = 0;
        while (i <Todo.getCat().size()) {
            if (categorie.equals(Todo.getCat().get(i).getName())) {
                ((RelativeLayout) findViewById(R.id.textBar)).setBackgroundColor(Todo.getCat().get(i).getColor());
                ((RelativeLayout) findViewById(R.id.textBar1)).setBackgroundColor(Todo.getCat().get(i).getColor());
                ((TextView) findViewById(R.id.title)).setBackgroundColor(Todo.getCat().get(i).getColor());
                selection = i;
            }
            i++;
        }
    ...
    public void addItemsOnSpinner2() {
        ...
        int i = 0;
        while (i < Todo.getCat().size()) {
            list.add(Todo.getCat().get(i).getName());
            i++;
        }
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ((RelativeLayout) findViewById(R.id.textBar)).setBackgroundColor(Todo.getCat().get(position).getColor());
                ((RelativeLayout) findViewById(R.id.textBar1)).setBackgroundColor(Todo.getCat().get(position).getColor());
                ((TextView) findViewById(R.id.title)).setBackgroundColor(Todo.getCat().get(position).getColor());
            }
