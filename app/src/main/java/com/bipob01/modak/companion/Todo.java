...
public class Todo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intentMain = new Intent(Todo.this, EditItem.class);
        ...
        ItemAdapter adapter = new ItemAdapter(Todo.this, items);
        checkAdapter adapter1 = new checkAdapter(Todo.this, cat);
    ...
    public void add(View v) {
        Intent intentMain = new Intent(Todo.this, AddItem.class);
        startActivityForResult(intentMain, 1);
    }
    ...
    public void affListCorresponding() {
        ...
        ItemAdapter adapter = new ItemAdapter(Todo.this, tmp);
        mListView.setAdapter(adapter);
        if (tmp.size() > 1)
    ...
    public void addCategorie(View v) {
        Intent intentMain = new Intent(Todo.this, addCatagory.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.todo_attendance_item:{
